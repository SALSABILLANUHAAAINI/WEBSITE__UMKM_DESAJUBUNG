...
<div class="tentang-container">
    ...
    <form action="{{ route('admin.tentang.update') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <img id="preview1"
                src="{{ isset($tentang->image1) ? asset('about_images/'.$tentang->image1) : '' }}"
                width="150" class="mb-2"
                style="{{ isset($tentang->image1) ? '' : 'display:none;' }}">
            <div id="drop1" class="upload-box"><p>Klik atau drag gambar 1</p></div>
        ...
        <div class="form-group">
            ...
            <img id="preview2"
                src="{{ isset($tentang->image2) ? asset('about_images/'.$tentang->image2) : '' }}"
                width="150" class="mb-2"
                style="{{ isset($tentang->image2) ? '' : 'display:none;' }}">
            <div id="drop2" class="upload-box"><p>Klik atau drag gambar 2</p></div>
        ...
        <div class="form-group">
            ...
            <textarea id="desc1" name="desc1" class="form-input" rows="4">{{ old('desc1', $tentang->desc1 ?? '') }}</textarea>
        </div>
...
function handleDropArea(dropId, inputId, previewId) {
    ...
    fileInput?.addEventListener("change", () => updatePreview(fileInput, previewImg, dropArea));
}
...
function updatePreview(fileInput, previewImg, dropArea) {
    if (fileInput.files.length > 0) {
        ...
        reader.onload = e => { previewImg.style.display='block'; previewImg.src=e.target.result; }
