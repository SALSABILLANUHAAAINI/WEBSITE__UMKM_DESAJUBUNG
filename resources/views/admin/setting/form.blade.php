        ...
        <div class="card-container">
            @forelse($submissions as $sub)
                <div class="service-card
                    @if($sub->status == 'rejected') card-rejected 
                    @elseif($sub->status == 'pending') card-pending
                    @elseif($sub->status == 'accepted') card-accepted
                    @endif">
                    ...
                    <p class="card-status">
                        ...
                        @elseif($sub->status == 'accepted') Diterima
                        @else - @endif
                    </p>
