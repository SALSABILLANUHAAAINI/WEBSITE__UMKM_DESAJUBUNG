  ...
  <div class="container about-grid">
    <div class="about-media reveal" data-reveal="left">
      <div class="media-frame">
        <img src="{{ $tentang && $tentang->image1 ? asset('about_images/'.$tentang->image1) : asset('images/dummy14.jpg') }}" alt="Gambar 1">
      </div>
    </div>
...
<section class="about-section alt">
  <div class="container about-grid">
    ...
    <div class="about-media reveal" data-reveal="right">
      <div class="media-frame">
        <img src="{{ $tentang && $tentang->image2 ? asset('about_images/'.$tentang->image2) : asset('images/dummy13.jpg') }}" alt="Gambar 2">
      </div>
    </div>
  </div>
</section>
...
(function(){
    ...
    document.querySelectorAll('.media-frame').forEach(frame=>{
        frame.addEventListener('mousemove', e=>{
            ...
            const dx=((e.clientX-r.left)/r.width-0.5)*4;
