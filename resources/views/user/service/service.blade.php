    ...
    <div class="form-block">
      ...
      <div class="grid-2">
        <div class="form-group">
          ...
          <input type="text" id="brand" name="nama_umkm" required>
        </div>
      ...
      <div class="form-group">
        ...
        <textarea id="address" name="alamat" rows="2" required></textarea>
      </div>
      ...
      <div class="grid-2">
        <div class="form-group">
          ...
          <input type="text" id="phone" name="kontak" required>
        </div>
        ...
        <div class="form-group">
          ...
          <div class="single-preview" id="umkmLogoPreview"></div>
        </div>
      </div>
